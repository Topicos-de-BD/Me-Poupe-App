...
function CadastroForm({Login, error}) {
    ...
    const [details, setDetails] = useState({name:"", email: "", cpf:"", password:"", termos:""});
    ...
    return (   
        <form onSubmit={submitHandler}>
            <div className='form-inner corpo'>
                ...
                <label htmlFor="email"></label>
                <input type="text" name='cpf' placeholder="CPF" id='cpf' onChange={e => setDetails({...details, cpf: e.target.value})} value={details.cpf}/>
