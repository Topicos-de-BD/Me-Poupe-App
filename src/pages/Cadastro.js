...
async function writeUserData(name, email, cpf, password) {
...
const Login = (props) => {
    ...
    const Login = details => {
        ...
        if (VerificaCampo(details.name) && VerificaCampo(details.email) && VerificaCampo(details.cpf) && VerificaCampo(details.password)) {
            if (details.termos === "") {
                ...
                writeUserData(details.name, details.email, details.cpf, details.password).then(result => {
                    if(isEmailValid) {
                        setUser({
                            ...user,
                            name: details.name,
